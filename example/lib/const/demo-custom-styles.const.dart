...
// Parameters can be overwritten in order to create a specific style for an editor.
List<EditorStylesM> DEMO_CUSTOM_STYLES = [
  // Headings
  EditorStylesM(
    h1: TextBlockStyleM(
      TextStyle(
  ...
  // Paragraphs and typography emphasis
  EditorStylesM(
    h1: TextBlockStyleM(
      TextStyle(
        fontSize: 34,
  ...
  EditorStylesM(
    ...
    lists: ListBlockStyle(
      ...
      VerticalSpacing(top: 0, bottom: 30),
